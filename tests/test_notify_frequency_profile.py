...
class NotifyFrequencyProfileTests(unittest.TestCase):
    ...
    def test_default_level_is_dengeli(self) -> None:
        self.assertEqual(DEFAULT_NOTIFY_FREQUENCY_LEVEL, "3")
    ...
    def test_increase_decrease_levels(self) -> None:
        ...
        apply_notify_frequency_level("6", persist=False)
    ...
    def test_bootstrap_persists_default(self) -> None:
        ...
        payload = build_notify_frequency_payload()
        self.assertIn("Dengeli", payload["active_label"])
