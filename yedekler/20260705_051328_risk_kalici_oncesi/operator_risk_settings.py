...
def update_operator_risk_settings(payload: dict[str, Any]) -> OperatorRiskSettings:
...
def apply_risk_preset(preset_id: str) -> OperatorRiskSettings | None:
    ...
    if not isinstance(values, dict):
        return None
    return update_operator_risk_settings(dict(values))
