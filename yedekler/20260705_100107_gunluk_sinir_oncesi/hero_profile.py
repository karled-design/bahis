...
HERO_PROFILE_LEVELS: dict[str, _HeroLevel] = {
    ...
    "3": {
        ...
        "increase_hint": "Ust seviye (Aktif): guven ~%55, gunde 4 aday, daha sik fikir.",
    ...
    "4": {
        ...
        "summary": "Tutma ihtimali ~%55+. Gunde en fazla 4 aday, stake %3.",
        "increase_hint": "Ust seviye (Cesur): guven ~%54, gunde 5 aday; win rate dusebilir.",
    ...
    "5": {
        ...
        "summary": "Tutma ihtimali ~%54+. Gunde en fazla 5 aday, stake %3,5; win rate dusabilir.",
        "increase_hint": "En yuksek seviye. Daha fazla bildirim icin profil siniri yok.",
        "decrease_hint": "Alt seviye (Aktif): guven ~%55, gunde 4 aday, daha az risk.",
        "values": {
            "min_confidence": 0.54,
            "net_superiority": 0.08,
            "soft_odds_min": 1.35,
