...
def select_rotated_sharp_sport_keys(
    *,
    rotation_index: int,
    ...
    candidates verilirse secim o listeden yapilir (kesif katmani sezon disi /
    macsiz ligleri eledikten sonra kalanlar); verilmezse acik liglerin tamami.
    """
    enabled = list(candidates) if candidates else list(get_enabled_sharp_sport_keys())
    if not enabled:
