...
def _save_state(state: dict[str, Any]) -> None:
    # Atomik yazim: once .tmp dosyaya yaz, sonra tek hamlede yerine koy. Boylece
    # baska bir tarama dosyayi TAM yazilirken okuyup yarim/bozuk JSON gormez.
    # Aksi halde _load_state bos varsayilana duser, "zaten soyledim" notu
    # (limit_notice_sent) silinir ve ayni "doldu" mesaji tekrar tekrar giderdi.
